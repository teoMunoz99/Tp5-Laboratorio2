        ...
        <form action="php/procesa.php" method="GET">
            ...
            <fieldset class="disabled">
                <section class="mb-3">
                    ...
                    <input type="text" id="name" class="form-control" min=0 name='nombre' required>
                </section>
                <section class="mb-3">
                    <label for="deposito" class="form-label">Depósito inicial: </label>
                    <input type="number" id="deposito" class="form-control" min=0 name='deposito' required>
                </section>
                <section>
                    <h5>Plazo: </h5>
            ...
            <section class="d-flex justify-content-center mt-3">
                <button class="btn btn-warning" type="submit">Simular</button>
            </section>
        </form>
    </section>
</main>
